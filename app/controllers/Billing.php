...
class Billing extends BaseController {
    ...
    public function getViewSalesInvoice(){
        ...
        return View::make('billing.viewsalesorders', $data);
    }
    ...
    public function postAddSalesOrder(){
        ...
        return Redirect::to('billing/view-sales-orders');
    }
    ...
    public function postEditSalesOrder(){
        ...
        return View::make('billing.editsalesorder', $data);
    }
