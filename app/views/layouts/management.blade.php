        ...
        <div class="navbar  navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="{{URL::to('management/')}}">Management Department</a>
                ...
                <div class="span2 f-osb">
                    <div class="well sidebar-nav bg-white">
                        <ul class="nav nav-list">
                            ...
                            <li><a href="{{URL::to('management/memos')}}">Memos</a></li>
                            <li><a href="{{URL::to('management/reminders')}}">Reminders</a></li>
<!--                            <li><hr></li>
                            <li class="nav-header"><i class="icon-tags"></i> Sales</li>
                            <li><a href="{{URL::to('management/view-sales-invoices')}}">View Sales Invoices</a></li>-->
                            <li><hr></li>
                            <li class="nav-header"><i class="icon-tags"></i> Sales</li>
                            <li><a href="{{URL::to('management/view-sales-orders')}}">View Sales Orders</a></li>
                            <li><hr></li>
                            <li class="nav-header"><i class="icon-money"></i> Purchasing</li>
                            <li><a href="{{URL::to('management/view-purchase-orders')}}">View Purchase Orders</a></li>
                            <li><hr></li>
...
<script>
            ...
            $.timer(function() {
                ...
                $.get("{{URL::to('management/notif')}}", function(data) {
                    ...
                    _.each(reminders, function(r){
                        remList += "<li class='nav-header'> "+r.created_by+"</li><li><a href='{{URL::to('management/reminders')}}'>"+r.reminder+"</a></li><li class='divider'></i>";
                    });
                   
                    _.each(memos, function(r){
                        memList += "<li class='nav-header'> "+r.created_by+"</li><li><a href='{{URL::to('management/memos')}}'>"+r.memo+"</a></li><li class='divider'></i>";
                    });
                    _.each(rolls, function(r){
                        rolList += "<li class='nav-header'> roll "+r.id+"</li><li ><a href='{{URL::to('management/view-rolls')}}'>has only "+r.quantity+" left</a></li><li class='divider'></i>";
                    });
                    _.each(products, function(r){
                        proList += "<li class='nav-header'> roll "+r.id+"</li><li ><a href='{{URL::to('management/view-products')}}'>has only "+r.quantity+" left</a></li><li class='divider'></i>";
                    });
