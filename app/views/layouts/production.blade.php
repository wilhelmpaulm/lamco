        ...
        <div class="navbar  navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="{{URL::to('production/')}}">Production Department</a>
...
<script>
            ...
            $.timer(function() {
                ...
                $.get("{{URL::to('production/notif')}}", function(data) {
                    ...
                    _.each(reminders, function(r){
                        remList += "<li class='nav-header'> "+r.created_by+"</li><li><a href='{{URL::to('production/reminders')}}'>"+r.reminder+"</a></li><li class='divider'></i>";
                    });
                   
                    _.each(memos, function(r){
                        memList += "<li class='nav-header'> "+r.created_by+"</li><li><a href='{{URL::to('production/memos')}}'>"+r.memo+"</a></li><li class='divider'></i>";
                    });
                    _.each(rolls, function(r){
                        rolList += "<li class='nav-header'> roll "+r.id+"</li><li ><a href='{{URL::to('production/view-rolls')}}'>has only "+r.quantity+" left</a></li><li class='divider'></i>";
                    });
                    _.each(products, function(r){
                        proList += "<li class='nav-header'> roll "+r.id+"</li><li ><a href='{{URL::to('production/view-products')}}'>has only "+r.quantity+" left</a></li><li class='divider'></i>";
                    });
