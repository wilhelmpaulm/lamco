...
<form id="mamamia"  class="" action="{{URL::to('purchasing/apply-edit-purchase-order')}}" method="post">
  ...
  <!--<input class="input-medium" type="text" name="vendor" value="" placeholder="Vendor Papers"/>-->
            <label for="vendor">Vendor</label> 
             <input class="input-block-level" disabled="true" type="text" name="id" value="{{$po->vendor}}" />
        ...
        <div class="span9">
            ...
            <div class="row-fluid">
                ...
                <div class="span3">
                    <a  class="btn btn-info btn-block"  href="{{URL::to('purchasing/view-purchase-orders')}}">Back</a>
                </div>
            </div>
        </div>
    </div>
